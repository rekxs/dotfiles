...
---VARIABLES
------------------------------------------------------------------------
myFont          = "xft:Hack Font:regular:pixelsize=12"
...
main = do
    ...
    xmproc0 <- spawnPipe "xmobar -x 0 /home/milan/.config/xmobar/xmobarrc0"
    xmproc1 <- spawnPipe "xmobar -x 1 /home/milan/.config/xmobar/xmobarrc2"
    xmproc2 <- spawnPipe "xmobar -x 2 /home/milan/.config/xmobar/xmobarrc1"
